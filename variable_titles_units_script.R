...
macroeconomic_variables_df <- macroeconomic_variables_df |>
  mutate(title_i = case_when(variable == "interest_rate" ~ "Interest Rate",
         ...
         var_info = case_when(variable == "interest_rate" ~ "yearly average of official Bank rate",
                                ...
                                variable == "poverty_rate" ~ "proportion below 60% of the inflation adjusted 2010 median income. This is the official absolute poverty rate.",
                                variable == "child_poverty_rate" ~ "proportion below 60% of the inflation adjusted 2010 median income. This is the official absolute poverty rate.",
